...
const int SRW_UPDATE_RANGE = 6010;
const int SRW_UPDATE_FILTER = 6020;
const int SRW_UPDATE_ROTATE = 6030;
const int SRW_UPDATE_CENTERLINE = 6040;
const int SRW_UPDATE_TICKSPACING = 6050;

const int TAG_FUNC_SRW_CENTERLINE_EDITOR = 6140;
const int TAG_FUNC_SRW_TICKSPACING_EDITOR = 6150;
